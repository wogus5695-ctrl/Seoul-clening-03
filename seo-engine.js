...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const heroDescTemplate = {
        ...
        "유리창청소": "쇼윈도와 전면 창에 누적된 뿌연 유막 and 고착된 물때를 제거해 매장의 개방감을 극대화하고 외부 시야를 맑게 회복해 드립니다.",
        ...
        "사무실청소": "{loc} 사무실청소는 쾌적한 업무 공간 조성을 위해 책상 주변, 회의실, 탕비실, 공용 공간의 묵은 먼지부터 바닥 찌든 때까지 디테일하게 청소합니다.",
        "상가청소": "{loc} 상가청소는 매장을 찾는 고객의 첫인상을 극대화하기 위해 쇼윈도 유리창, 바닥의 찌든 얼룩, 고객 동선 구역을 맞춤형으로 세정합니다.",
        "공장청소": "{loc} 공장청소는 근로자의 안전과 생산 효율을 위해 작업장의 먼지와 설비 분진, 바닥에 고착된 찌든 기계 오일 기름때를 정밀 기계 청소합니다.",
        "건물청소": "{loc} 건물청소는 복도, 계단, 공용 화장실, 입구 로비 등 입주민과 방문객들이 상시 동행하는 공용 공간을 정기 또는 일회성 기계 세정으로 맑게 관리합니다.",
        "침수청소": "{loc} 침수청소는 누수나 비 피해로 바닥에 차오른 오염수와 유입된 진흙 토사를 대형 흡입기로 정돈하고, 악취 방역 소독을 진행합니다.",
        "창고청소": "{loc} 창고청소는 보관 랙과 물류 선반에 누적된 낙하 미세 먼지 진공 청소 및 지게차 이동 동선 바닥의 타이어 스크래치 고무 자국을 기계로 세척합니다.",
        "병원청소": "{loc} 병원청소는 병의원 대기실과 진료실, 화장실 등 내원 환자가 이용하는 다목적 보건 공간에 전용 약품 소독 세정 공정을 적용해 위생 환경을 지킵니다.",
    ...
    const needSituationHeadingTemplate = {
        ...
        "쓰레기집청소": "오랜 방치로 인한 신속히 악취와 위생 위협을 해결하고 싶으신가요?",
        "특수청소": "일반적인 물청소나 화학 세제로 해결되지 않는 악성 오염원과 바이러스 방역이 필요하신가요?",
        "사무실청소": "업무공간 청결은 첫인상과 근무환경을 함께 좌우합니다",
        "상가청소": "상가는 고객이 보는 동선부터 정리되어야 합니다",
        "공장청소": "공장청소는 면적보다 오염 종류를 먼저 봐야 합니다",
        "건물청소": "건물청소는 공용부와 외부 노출 구역을 함께 확인해야 합니다",
        "침수청소": "침수 후에는 물기 제거보다 오염 범위 확인이 먼저입니다",
        "창고청소": "창고청소는 적재물과 동선을 기준으로 범위를 나눠야 합니다",
        "병원청소": "병원청소는 환자 동선과 위생 구역을 구분해야 합니다",
    ...
    const needDescTemplate = {
        ...
        "사무실청소": "{loc}에서 사무실청소 작업이 필요하다면, 책상 주변과 회의실, 탕비실, 바닥 오염 상태를 기준으로 작업 가능 범위를 확인합니다.",
        "상가청소": "{loc}에서 상가청소 작업이 필요하다면, 매장 바닥과 출입문, 진열대 주변, 고객 동선을 기준으로 작업 범위를 확인합니다.",
        "공장청소": "{loc}에서 공장청소 작업이 필요하다면, 작업장 바닥과 기계 주변, 분진, 기름때 범위를 기준으로 청소 가능 여부를 확인합니다.",
        "건물청소": "{loc}에서 건물청소 작업이 필요하다면, 복도와 계단, 출입구, 공용부 바닥 상태를 기준으로 작업 범위를 확인합니다.",
        "침수청소": "{loc}에서 침수청소 작업이 필요하다면, 잔수와 오염수 흔적, 악취 발생 구역, 바닥 상태를 기준으로 작업 가능 여부를 확인합니다.",
        "창고청소": "{loc}에서 창고청소 작업이 필요하다면, 적재 공간과 선반 구석, 바닥 먼지, 폐기물 정리 범위를 기준으로 확인합니다.",
        "병원청소": "{loc}에서 병원청소 작업이 필요하다면, 대기실과 진료실 주변, 화장실, 공용부 바닥 상태를 기준으로 작업 범위를 확인합니다.",
    ...
    const faqQ1Template = {
        ...
        "화재청소": "{loc} 화재청소는 그을음 and 탄 냄새까지 정리할 수 있나요?",
        ...
        "사무실청소": "{loc} 사무실청소는 주말이나 퇴근 시간대 작업이 가능한가요?",
        "상가청소": "{loc} 상가청소 시 매장 전면 쇼윈도 유리도 함께 닦아주나요?",
        "공장청소": "{loc} 공장청소 중 안전 확보 및 기계 설비 손상 방지는 어떻게 되나요?",
        "건물청소": "{loc} 건물청소 범위에 주차장이나 외부 화단 먼지 정리도 포함되나요?",
        "침수청소": "{loc} 침수청소 시 고여 있는 진흙 뻘흙과 오물도 같이 흡입해 주나요?",
        "창고청소": "{loc} 창고청소 진행 중 적재 물품이나 상자 파손 보양은 어떻게 되나요?",
        "병원청소": "{loc} 병원청소 시 진료 대기실 소파나 의자 세척도 가능한가요?",
    ...
    const faqA1Template = {
        ...
        "사무실청소": "네, 업무에 전혀 방해가 되지 않도록 사전 예약 일정 조율을 거쳐 주말 휴무일이나 야간 및 새벽 시간대에 전담 청소팀이 신속하게 클리닝을 진행합니다.",
        "상가청소": "네, 고객의 시선이 가장 먼저 닿는 매장 정면 쇼윈도 유리의 빗물 얼룩, 유막, 손자국 등은 물론 입구 주변 프레임의 먼지까지 스퀴징 및 유리 정밀 세정 공정으로 투명하게 복원합니다.",
        "공장청소": "기계 내부 부품은 세척하지 않으며 외부 프레임과 주변 진공 먼지 털이 위주로 진행하고, 가동 중인 장비 주변은 내열 보양 필름으로 사전 차단하여 전기 누전 및 2차 오염 우려 없이 확실히 통제합니다.",
        "건물청소": "네, 건물의 계단과 복도 등 실내 공용 공간뿐 아니라, 외부 현관 출입구 주변의 흙먼지와 주차구역 구석의 방치 쓰레기, 낙엽까지 건물 관리 플랜에 맞춰 패키지로 조율하여 정리해 드립니다.",
        "침수청소": "네, 고압수 세정을 투입해 진흙 얼룩을 물에 희석하고 산업용 배수 양수 펌프 및 대형 습식 집수기를 동원해 바닥 틈과 타일 사이에 낀 토사를 걷어냅니다.",
        "창고청소": "보관 중인 종이 상자나 자재 위로 먼지나 물이 비산되는 것을 원천 차단하기 위해 작업 동선 전 구역에 친환경 보호 비닐 팩 보양을 씌운 뒤 구역을 안전하게 쪼개어 세밀하게 시공합니다.",
        "병원청소": "네, 환자들이 수시로 접촉하는 대기홀 패브릭 소파 및 가죽 체어 등은 화학 냄새가 남지 않는 친환경 중성 탈균 클리너를 분사하고 정밀 고온 스팀기로 세정하여 찌든 얼룩을 씻어냅니다.",
    ...
    const faqQ2Template = {
        ...
        "바닥청소": "매장 바닥 and 사무실 바닥은 청소 방식이 다른가요?",
        ...
        "사무실청소": "사무실 개인 책상 위 비품이나 서류 등도 전부 닦아주시나요?",
        "상가청소": "요식업 매장의 경우 홀 바닥의 미끄러운 기름때도 기계 청소가 되나요?",
        "공장청소": "높은 천장에 걸린 배관이나 철골 구조물 위 먼지 제거도 가능한가요?",
        "건물청소": "계단 난간이나 엘리베이터의 스틸 프레임 손자국과 얼룩도 잘 지워지나요?",
        "침수청소": "침수 후 젖은 벽지나 썩은 바닥재 냄새 완화가 가능한가요?",
        "창고청소": "지게차가 급제동하며 남긴 시커먼 스키드 마크 자국도 제거되나요?",
        "병원청소": "레이저나 엑스레이 같은 고가 정밀 의료 장비도 닦아주나요?",
    ...
    const faqA2Template = {
        ...
        "사무실청소": "개인 정보 보호와 비품 유실 방지를 위해 책상 위의 중요 서류나 PC 주변은 가벼운 먼지 제거 중심 수작업으로 가이드에 맞춰 안전하게 진행하며, 파손 없이 정돈합니다.",
        "상가청소": "네, 주방에서 유입되어 바닥재에 고착된 미끄러운 유분과 기름때는 친환경 전용 연화제를 도포한 후 돌돌이 마루 세척기를 동원해 찌든 때를 안전하게 분해 및 회수 세정합니다.",
        "공장청소": "네, 천장 H빔이나 철골 구조 위에 쌓인 오랜 먼지는 추락 위험이 있으므로 스카이 고소차를 현장 진로에 맞춰 안전 배치하여 숙련공이 올라가 강력 건식 흡입 세정을 거쳐 안전하게 청소합니다.",
        "건물청소": "엘리베이터 거울 및 스테인리스 내벽의 유분 얼룩은 표면 스크래치를 예방하기 위해 부드러운 전용 스틸 광택제와 극세사 패드로 버핑 처리하여 변색 없이 지워냅니다.",
        "침수청소": "바닥 세정 공정을 마친 직후, 습기로 인한 곰팡이 냄새 분자를 파괴하기 위해 공간 방역 살균 소독 처리를 하고 특수 살균 방역제를 골고루 안개 분사하여 2차 취기 발생을 억제합니다.",
        "창고청소": "네, 바닥 데코타일이나 에폭시에 녹아붙은 타이어 고무 자국은 일반 물청소로 지워지지 않으므로, 고성능 타이어 고무 연화 약제를 도포해 녹여낸 다음 기계 솔 돌돌이 공정으로 긁어 지워냅니다.",
        "병원청소": "고가 의료 정밀 기기는 훼손 리스크 방지를 위해 본체 내부나 전기 스위치는 다치지 않게 보양하며, 주변 프레임 표면의 가벼운 정밀 먼지만 털어 수작업 버핑 마감합니다.",
    ...
    const possibleWorksHeadingTemplate = {
        ...
        "사무실청소": "클린폼에서 가능한 청소 작업",
        "상가청소": "클린폼에서 가능한 청소 작업",
        "공장청소": "클린폼에서 가능한 청소 작업",
        "건물청소": "클린폼에서 가능한 청소 작업",
        "침수청소": "클린폼에서 가능한 청소 작업",
        "창고청소": "클린폼에서 가능한 청소 작업",
        "병원청소": "클린폼에서 가능한 청소 작업",
    ...
    const possibleWorksSubtitleTemplate = {
        ...
        "사무실청소": "{loc}에서 사무실청소 작업이 필요하다면, 현장 사진과 작업 범위를 기준으로 가능 여부를 확인합니다.",
        "상가청소": "{loc}에서 상가청소 작업이 필요하다면, 현장 사진과 작업 범위를 기준으로 가능 여부를 확인합니다.",
        "공장청소": "{loc}에서 공장청소 작업이 필요하다면, 현장 사진과 작업 범위를 기준으로 가능 여부를 확인합니다.",
        "건물청소": "{loc}에서 건물청소 작업이 필요하다면, 현장 사진과 작업 범위를 기준으로 가능 여부를 확인합니다.",
        "침수청소": "{loc}에서 침수청소 작업이 필요하다면, 현장 사진과 작업 범위를 기준으로 가능 여부를 확인합니다.",
        "창고청소": "{loc}에서 창고청소 작업이 필요하다면, 현장 사진과 작업 범위를 기준으로 가능 여부를 확인합니다.",
        "병원청소": "{loc}에서 병원청소 작업이 필요하다면, 현장 사진과 작업 범위를 기준으로 가능 여부를 확인합니다.",
    ...
    const midCtaTextTemplate = {
        ...
        "사무실청소": "{loc}에서 사무실청소 작업이 필요하다면, 현장 상태와 작업 범위를 기준으로 가능 여부를 안내드립니다.",
        "상가청소": "{loc}에서 상가청소 작업이 필요하다면, 현장 상태와 작업 범위를 기준으로 가능 여부를 안내드립니다.",
        "공장청소": "{loc}에서 공장청소 작업이 필요하다면, 현장 상태와 작업 범위를 기준으로 가능 여부를 안내드립니다.",
        "건물청소": "{loc}에서 건물청소 작업이 필요하다면, 현장 상태와 작업 범위를 기준으로 가능 여부를 안내드립니다.",
        "침수청소": "{loc}에서 침수청소 작업이 필요하다면, 현장 상태와 작업 범위를 기준으로 가능 여부를 안내드립니다.",
        "창고청소": "{loc}에서 창고청소 작업이 필요하다면, 현장 상태와 작업 범위를 기준으로 가능 여부를 안내드립니다.",
        "병원청소": "{loc}에서 병원청소 작업이 필요하다면, 현장 상태와 작업 범위를 기준으로 가능 여부를 안내드립니다.",
    ...
    const heroImgAltTemplate = {
        ...
        "사무실청소": "{loc} 사무실 업무 구역과 회의실의 먼지 흡입 및 정밀 습식 청소를 진행하는 모습",
        "상가청소": "{loc} 매장 전면 유리창 세정 및 홀 바닥 기계 세척을 진행하는 모습",
        "공장청소": "{loc} 공장의 넓은 에폭시 바닥 기름때를 기계 세척하고 철골 분진을 진공 흡입하는 모습",
        "건물청소": "{loc} 건물의 로비 대리석 바닥 기계 습식 청소 및 계단 난간 틈새 오염을 정리하는 모습",
        "침수청소": "{loc} 침수 현장 바닥의 오수와 토사를 습식 진공 흡입기로 정밀 제거하는 모습",
        "창고청소": "{loc} 물류 창고 바닥의 지게차 타이어 마크 기계 연마 및 수납 랙 먼지 흡입을 하는 모습",
        "병원청소": "{loc} 진료 병원의 내부 대기실 바닥 습식 세척 및 소파 고온 살균 닦기 모습",
        "종합청소": "{loc} 전문 청소 장비 and 인력으로 작업 중인 클린폼"
    };�은 빗물 얼룩과 푸른 곰팡이가 피어 매장 전면 이미지를 해치고 있나요?",
        "간판청소": "외부에 노출된 상가 간판에 먼지와 곤충 사체가 가득해 조명이 어둡고 칙칙해 보이나요?",
        "준공청소": "신축 공사가 끝나고 미세 시멘트 가루와 본드 자국이 가득해 최종 마감 검수를 앞두고 계신가요?",
        "인테리어 후 청소": "리모델링 목공 작업 후 서랍 내부와 가구 틈새에 미세 톱밥 먼지가 뿌옇게 쌓여 걱정이신가요?",
        "후드청소": "주방 환풍기 필터와 후드 내벽에 끈적한 누런 기름때가 고여 화재 위험과 위생이 걱정되시나요?",
    ...
    const titleTemplates = {
        ...
        "사무실청소": "{loc} 사무실청소 견적 상담 | 클린폼",
        "상가청소": "{loc} 상가청소 견적 상담 | 클린폼",
        "공장청소": "{loc} 공장청소 견적 상담 | 클린폼",
        "건물청소": "{loc} 건물청소 견적 상담 | 클린폼",
        "침수청소": "{loc} 침수청소 견적 상담 | 클린폼",
        "창고청소": "{loc} 창고청소 견적 상담 | 클린폼",
        "병원청소": "{loc} 병원청소 견적 상담 | 클린폼",
    ...
    const h1Templates = {
        ...
        "사무실청소": "{loc} 사무실청소 전문 클린폼",
        "상가청소": "{loc} 상가청소 전문 클린폼",
        "공장청소": "{loc} 공장청소 전문 클린폼",
        "건물청소": "{loc} 건물청소 전문 클린폼",
        "침수청소": "{loc} 침수청소 전문 클린폼",
        "창고청소": "{loc} 창고청소 전문 클린폼",
        "병원청소": "{loc} 병원청소 전문 클린폼",
    ...
    const descTemplates = {
        ...
        "사무실청소": "{loc} 사무실청소가 필요하다면 현장 사진, 면적, 오염 상태를 기준으로 작업 가능 여부와 예상 견적 범위를 안내드립니다.",
        "상가청소": "{loc} 상가청소가 필요하다면 현장 사진, 면적, 오염 상태를 기준으로 작업 가능 여부와 예상 견적 범위를 안내드립니다.",
        "공장청소": "{loc} 공장청소가 필요하다면 현장 사진, 면적, 오염 상태를 기준으로 작업 가능 여부와 예상 견적 범위를 안내드립니다.",
        "건물청소": "{loc} 건물청소가 필요하다면 현장 사진, 면적, 오염 상태를 기준으로 작업 가능 여부와 예상 견적 범위를 안내드립니다.",
        "침수청소": "{loc} 침수청소가 필요하다면 현장 사진, 면적, 오염 상태를 기준으로 작업 가능 여부와 예상 견적 범위를 안내드립니다.",
        "창고청소": "{loc} 창고청소가 필요하다면 현장 사진, 면적, 오염 상태를 기준으로 작업 가능 여부와 예상 견적 범위를 안내드립니다.",
        "병원청소": "{loc} 병원청소가 필요하다면 현장 사진, 면적, 오염 상태를 기준으로 작업 가능 여부와 예상 견적 범위를 안내드립니다.",
