...
module.exports = (req, res) => {
    ...
    const possibleWorksHeadingTemplate = {
        "외벽청소": "{loc} 외벽청소 전문 상담 사례",
        "유리창청소": "{loc} 유리창 물때 제거 상담 사례",
        "화재청소": "{loc} 화재청소 그을음 탄 냄새 제거 사례",
        "바닥왁스코팅": "{loc} 바닥왁스코팅 타일 보호막 시공 사례",
        "바닥청소": "{loc} 바닥청소 찌든 때 제거 사례",
        "어닝청소": "{loc} 어닝청소 곰팡이 얼룩 제거 사례",
        "간판청소": "{loc} 간판청소 벌레 자국 세척 사례",
        "준공청소": "{loc} 준공청소 공사 분진 정리 사례",
        "인테리어 후 청소": "{loc} 인테리어청소 공사 후 먼지 정리 사례",
        "후드청소": "{loc} 후드청소 주방 기름때 관리 사례",
        "쓰레기집청소": "{loc} 쓰레기집청소 폐기물 수거 정리 사례",
        "특수청소": "{loc} 특수청소 현장 맞춤 위생 소독 사례",
        "종합청소": "{loc} 종합청소 현장 클리닝 상담 사례"
    };
